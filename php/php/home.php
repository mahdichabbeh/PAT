    ...
    <body>
        <header>
            <nav>   
                ...
                <ul class="navbar">
                    <li><a href="home.php"><span class="underlined">HOME</a></li>
            ...
            <div class="content">
                ...
                <p> Non-profit organization <br> to protect animals <br> in Tunisia.</p>
                <a href="registrationform.php" class="buttom1">Sign Up</a>
                <a href="loginform.php" class="buttom2">Sign In</a>
                    ...
                    <div class="card">        
                        <img src="../assets/cat3.jpg"  alt="Mohamed Karim Jegham"  l/>
                         <div class="discr">
                            ...
                            <a href="services.php" href="services.php" class="showmore"> Show more</a>
                        </div>
                    </div>
                    <div class="card">        
                        ...
                        <div class="discr">
                            ...
                            <a href="services.php" class="showmore"> Show more</a>
                        </div>
                    </div>
                    <div class="card">        
            ...
            <section class="contactus">
                <div class="desc">
                    ...
                    <a  href="contact.php" class="buttom">Contact Us</a>
                </div>
                <div id="partners">
