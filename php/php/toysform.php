...
<head>
    ...
    <body>
        <div class="container">  
            <form action="toys.php" method="post" onsubmit="return validateForm()">
                ...
                <label for="phone"> Phone Number:<input   type="phone" id="phone" size="15" max="9" class="personal" name="number"> </label>
