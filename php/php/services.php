...
<head>
       ...
       <header>
          <nav>
            ...
            <ul class="navbar">
                ...
                <li><a href="services.php"><span class="underlined">SERVICES</span></a>
                    <ul>
  ...
  <body >
    <section id="adoption">
            ...
            <a href="adoptform.php" ><button class="adopt">adopt now</button></a>
         </section>
        <section id="volunter">
          ...
          <div class="button-container">
            <a href="volunteerform.php" class="button">Volunteer</a>
          </div>
    ...
    <section id="donate">
      ...
      <div class="container">
            <div class="card"> 
              ...
              <div class="discr"><a href="foodform.php"><button class="discrb">Food</button> </a></div>
            </div>
            <div class="card">        
              <img src="../assets/toys1.jpg"  alt="Mohamed Karim Jegham" class="img2" l/>
              <div class="discr"><a href="toysform.php"><button class="discrb">Toys</button> </a></div>
            </div>
            <div class="card">        
              <img src="../assets/money1.jpg"  alt="Mohamed Karim Jegham" class="img2" l/>
              <div class="discr"><a href="moneyform.php"><button class="discrb">Money</button> </a> </div>
            </div>
      </div>
    </section> 
    <footer>
